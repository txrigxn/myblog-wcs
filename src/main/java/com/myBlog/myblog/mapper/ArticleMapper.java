...
public class ArticleMapper {
  ...
  public ArticleDto convertToDto(Article article) {
    ...
    if (article.getImages() != null) {
      articleDto.setImageUrls(
          article.getImages().stream().map(Image::getUrl).collect(Collectors.toList()));
    }
    if (article.getArticleAuthors() != null) {
      articleDto.setAuthors(
          article.getArticleAuthors().stream()
